                ...
                <header>
                    <div class="row">
                        <div class="col-md-8 module-text">
                            <h2 class="module-title text-gray-900 dark:text-gray-100">Icons List</h2>
                            <p class="mt-1 text-sm g-color text-green">Here is a list of all the icons in our store.</p>
                        </div>
                    </div>
                </header>
                <!-- partial -->
