                ...
                @foreach ($blogs as $blog)
                    <div class="col-12 col-sm-6 col-md-4 mb-5">
                        <div class="post-entry">
                            <a href="{{ route('blog.details',$blog->url) }}" class="post-thumbnail"><img src="{{ get_image($blog->image,'blog') }}" alt="Image" class="img-fluid"></a>
                            <div class="post-content-entry">
                                <h3><a href="{{ route('blog.details',$blog->url) }}">{{ substr($blog->title,0,50) }}</a></h3>
                                <div class="meta">
